...
TOOLS=boost,gccdeps,clang_compilation_database,documentation,gtest,jenkins,mr,nosepatch,openmp,post_task,pypp,genpybind,pytest,symap2ic_doxygen,symwaf2ic,symwaf2ic_prelude,symwaf2ic_misc,test_base,visionflags,cross_ar,cross_as,cross_gcc,cross_gxx,nux_compiler,nux_assembler,objcopy,local_rpath
